...
namespace Project_Tiger_2._0
{
    public class Customer : Users
    {
...

        {
            ...
            while (logOut == false)
            {
                ...
                switch (choice)
                {
                    ...
                    case "4":
                        listOfCustomers[loggedInUserIndex].CreateNewBankAccount("TEST", 0, "USD");
                        break;
                    ...
                    case "8":
                        listOfCustomers[loggedInUserIndex].DepositMoneyToAccount(0, -100);
                        break;
        ...
        public void CreateNewBankAccount(string newAccountName, int amount, string currency) // Skapa nytt bankkonto
        {
        //    Console.Clear();
        ...
        //        }
            ...
            listOfBankAccounts.Add(new BankAccounts(newAccountName, amount, currency));
